...
contract TokenVesting is Ownable, ReentrancyGuard, Pausable, AccessControl {
     ...
     */
    constructor(IERC20Metadata token_) Ownable(msg.sender) {
        nativeToken = token_;
    ...
    function releaseAvailableTokensForHolder(address holder) external nonReentrant {
        ...
        for (uint256 i; i < vestingScheduleCount; i++) {
